      ...
      {/* <motion.div variants={nextVariants} initial="hidden" animate="visible">
        <div style={{color:"#7000FF", fontSize : "30px"}} className="text"><h2>Hey There :D</h2> <motion.div variants={childVariants}>grab your awesome T-Shirts</motion.div></div>
         ...
         <motion.h1
                 ...
                 initial="initial"
                    animate="visible"
                 style={{fontSize : "80px",borderRadius : "20px", background : "linear-gradient(90deg, #8CE2B7 35%, #166B41 100%)", color : "white" , marginTop: "100px"}}> 
                  Customize Your T-Shirt Contact Us  < AiOutlineWhatsApp /> &nbsp;
